...
# command.revision(alembic_cfg, message = "migration", autogenerate = True, version_path="migrations/testversions")
command.upgrade(alembic_cfg, revision = "head") # выполняем миграции